<?php require 'header.php'; ?>
	...
	<section id="main-content">
		...
		<section class="wrapper site-min-height">
			...
			<div class="col-lg-12">
				<h2><?= $this->lang->line('impostazioni');?></h2>

				<ul class="col-lg-12 nav nav-tabs">
					<li class="active"><a href="#generali" class="hvr-bounce-to-top"><?= $this->lang->line('generali_impostazioni');?></a></li>
					<li><a href="#admin" class="hvr-bounce-to-top"><?= $this->lang->line('admin_impostazioni');?></a></li>
					<li><a href="#ordini" class="hvr-bounce-to-top"><?= $this->lang->line('o_e_r_titolo');?></a></li>
					<li><a href="#invoice" class="hvr-bounce-to-top"><?= $this->lang->line('invoice');?></a></li>
					<li><a href="#sms" class="hvr-bounce-to-top"><?= $this->lang->line('sms_titolo');?></a></li>
				</ul>

				<div class="tab-content">
					<div id="generali" class="tab-pane fade in active">
						<h3><?= $this->lang->line('general_title');?></h3>
						<div class="col-lg-12">
							<div class="form-group">
								<label>
									<?= $this->lang->line('nome_sito');?>
								</label>
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label>
									<?= $this->lang->line('valuta');?>
								</label>
								<select id="valuta" data-num="1" class="form-control m-bot15" style="width: 100%">
									<option <?php if($impostazioni[0][ 'valuta']=='EURO' ) echo 'selected'; ?>>Rupiah</option>
                        ...
                        <div class="row">
                        <div class="col-lg-12">
                            <h3> <?= $this->lang->line('color_title');?></h3>
                        </div></div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>
                                    <?= $this->lang->line('colorp_title');?>
                                </label>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <span class='label label-incorso label-mini' style="background: <?= $impostazioni[0]['colore1']; ?>;"><?= $this->lang->line('incorso'); ?></span>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <span class='label label-daconsegnare label-mini' style="background: <?= $impostazioni[0]['colore2']; ?>;"><?= $this->lang->line('daconsegnare'); ?></span>
                                <div class="input-group colori">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <span class='label label-inattesa label-mini' style="background: <?= $impostazioni[0]['colore3']; ?>;"><?= $this->lang->line('inattesa'); ?></span>
                                <div class="input-group colori">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <span class='label label-completato label-mini' style="background: <?= $impostazioni[0]['colore4']; ?>;"><?= $this->lang->line('completato'); ?></span>
                                <div class="input-group colori">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <span class='label label-nonriparato label-mini' style="background: <?= $impostazioni[0]['colore5']; ?>;"><?= $this->lang->line('nonriparato'); ?></span>
                                <div class="input-group colori">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3> <?= $this->lang->line('logop_title');?></h3>
                            </div>
                        </div>
                        <div class="col-lg-12">
					...
					<div id="admin" class="tab-pane fade">
						<h3><?= $this->lang->line('admin_title');?></h3>
						<div class="col-lg-12">
							<div class="form-group">
								<label>
					...
					<div id="ordini" class="tab-pane fade">
                        <h3><?= $this->lang->line('ordini_t_title');?></h3>
						<div class="col-lg-12">
							<div class="form-group">
								<label>
									<?= $this->lang->line('ordini_categorie');?>
								</label>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>
                                    <?= $this->lang->line('campi_addizionali');?>
                                </label>
...
foreach($campi as $line){
    echo '<option data-select2-tag="true" selected value="'.$line.'">'.$line.'</option>';
					...
					<div id="invoice" class="tab-pane fade">
						<h3><?= $this->lang->line('invoice_title');?></h3>
						<div class="col-lg-6">
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										<label>
											<?= $this->lang->line('invoice_name');?>
										</label>
										<div class="iconic-input right"><i class="fa fa-user"></i>
								...
								<div class="col-lg-12">
									<div class="form-group">
										<label>
											<?= $this->lang->line('invoice_indirizzo');?>
										</label>
						...
						<div class="col-lg-6">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group">
										<label>
											<?= $this->lang->line('invoice_telefono');?>
										</label>
								...
								<div class="col-lg-12">
									<div class="form-group">
										<label><?= $this->lang->line('invoice_vat');?></label>
						...
						<div class="col-lg-6">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group">
										<label><?= $this->lang->line('invoice_type');?></label>
								...
								<div class="col-lg-12">
									<div class="form-group">
										<label><?= $this->lang->line('invoice_tax');?></label>
					...
					<div id="sms" class="tab-pane fade">
                        ...
                        <div class="col-lg-6 skebby-info radio-sms" <?php if($impostazioni[0]['usesms'] == 1 ) echo 'style="opacity: 1;"'; ?>>
							...
							<div class="form-group">
								<label class="title">
									<?= $this->lang->line('skebby_title');?>
								</label>
								<input id="s_user" type="text" class="validate form-control" placeholder="<?= $this->lang->line('skebby_user');?>" value="<?= $impostazioni[0]['skebby_user']; ?>">
								<input id="s_password" type="text" class="validate form-control" placeholder="<?= $this->lang->line('skebby_password');?>" value="<?= $impostazioni[0]['skebby_pass']; ?>">
								<input id="s_sender" type="text" class="validate form-control" placeholder="<?= $this->lang->line('skebby_sender');?>" value="<?= $impostazioni[0]['skebby_name']; ?>">
								<input id="s_method" type="text" class="validate form-control" placeholder="<?= $this->lang->line('skebby_method');?>" value="<?= $impostazioni[0]['skebby_method']; ?>">
							</div>
						</div>
                        <div class="col-lg-6 twilio-info radio-sms" <?php if($impostazioni[0]['usesms'] == 2 ) echo 'style="opacity: 1;"'; ?>>
							...
							<div class="form-group">
								...
								<input id="t_account_sid" type="text" class="validate form-control" placeholder="<?= $this->lang->line('twilio_account_sid');?>" value="<?= $impostazioni[0]['twilio_account_sid']; ?>">
								<input id="t_token" type="text" class="validate form-control" placeholder="<?= $this->lang->line('twilio_token');?>" value="<?= $impostazioni[0]['twilio_auth_token']; ?>">
								<input id="t_number" type="text" class="validate form-control" placeholder="<?= $this->lang->line('twilio_number');?>" value="<?= $impostazioni[0]['twilio_number']; ?>">
							</div>
						</div>
                        </form>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label>
                                    <?= $this->lang->line('prefisso_internazionale');?>
                                </label>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h3><?= $this->lang->line('reparation_text');?></h3>
                            </div>
                        </div>
						<div class="col-lg-6">
							<div class="form-group">
								<label>
									<?= $this->lang->line('reparation_apertura');?>
								</label>
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label>
									<?= $this->lang->line('reparation_chiusura');?>
								</label>
